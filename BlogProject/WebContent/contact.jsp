                ...
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        ...
                        <div class="my-5">
                            ...
                            <!-- to get an API token!-->
                            <form id="contactForm" action="contactController">
                                ...
                                <div class="form-floating">
                                    <textarea class="form-control" name="massage" id="message" placeholder="Enter your message here..." style="height: 12rem" data-sb-validations="required"></textarea>
                              ...
                              <div class="d-none" id="submitSuccessMessage">
                                ...
                                <!-- Submit Button-->
                                <button class="btn btn-primary text-uppercase" name="flag" value="insert" id="submitButton" type="submit">Send</button>
                            </form>
                        </div>
                    </div>
                </div>
                ...
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        <ul class="list-inline text-center">
                            ...
                            <li class="list-inline-item">
                                <a href="https://github.com/codingthunder" target="_blank">
                                    <span class="fa-stack fa-lg">
                                        <i class="fas fa-circle fa-stack-2x"></i>
